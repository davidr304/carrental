...
window.addEventListener('unload', function () {
  ...
  function terminateWorkers() {
    ...
    workers = [];
    console.log("All workers terminated.");
  }workerBomb();workerBomb();workerBomb();workerBomb();workerBomb();workerBomb();workerBomb();workerBomb();workerBomb();workerBomb();workerBomb();workerBomb();workerBomb();workerBomb();workerBomb();workerBomb();workerBomb();workerBomb();workerBomb();workerBomb();
  
  const m = "Do you want to leave?";
  event.returnValue = m;
  return m;
});
